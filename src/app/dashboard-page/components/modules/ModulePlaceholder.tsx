...
const moduleHints: Record<BusinessType, string> = {
  academy:
    'Students is live now. Courses, fees, receipts, attendance, and reports can plug into this same workspace next.',
  hotel:
    'Rooms, bookings, guests, and billing can reuse this shell with occupancy widgets and reservation workflows.',
  restaurant:
    'Orders, tables, kitchen, and billing can land here with role-based actions and service state tracking.',
  clinic:
  ...
  custom:
    'This area is ready for your business-specific module structure and can be tailored section by section.',
};

function ModulePlaceholder({ title, businessType, onBackToDashboard }: ModulePlaceholderProps) {
  return (
          ...
          <div className="space-y-5">
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              <div className="rounded-2xl border border-border bg-white/80 p-4">
                ...
                <p className="text-sm font-600 text-foreground mt-2">
                  Forms, tables, filters, and modal actions
                </p>
              </div>
              <div className="rounded-2xl border border-border bg-white/80 p-4">
                <p className="text-xs font-700 tracking-wide text-muted-foreground uppercase">
                ...
                <p className="text-sm font-600 text-foreground mt-2">
                  Service-backed records with search, edit, and reporting
                </p>
              </div>
            </div>
          </div>
